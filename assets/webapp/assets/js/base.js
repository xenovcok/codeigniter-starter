...
if (Finapp.RTL.enable) {
	...
	document
		.querySelectorAll(
			".carousel-full, .carousel-single, .carousel-multiple,.carousel-multiplet .carousel-small, .carousel-slider"
		)
		.forEach(function (el) {
...
document.addEventListener("DOMContentLoaded", function () {
	...
	// Multiple Carousel
	document.querySelectorAll(".carousel-multiplet").forEach((carousel) =>
		new Splide(carousel, {
			perPage: 1,
			rewind: true,
			type: "loop",
	...
	document.querySelectorAll(".carousel-multiple-resto").forEach((carousel) =>
		new Splide(carousel, {
			perPage: 2,
			rewind: true,
			type: "loop",
	...
	document.querySelectorAll(".carousel-double").forEach((carousel) =>
		new Splide(carousel, {
			perPage: 2,
			rewind: true,
			type: "loop",
