...
|
*/
$config['rest_valid_logins'] = ['9v(u9nL+kR=x' => 'VGM,-*&=5_?&'];
...
$config['forced_cors_headers'] = [
	...
	'Access-Control-Allow-Headers' => 'Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, Access-Token, Client-Secret, Authorization, Authorize'
];
